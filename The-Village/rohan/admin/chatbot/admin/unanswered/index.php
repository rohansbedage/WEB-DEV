            ...
            <div class="left-sidebar-scroll">
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        <li class="parent "><a href="#"><i class="icon mdi mdi-pin"></i><span> Village Places
                                </span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href=""><i
                                    class="icon mdi mdi-chart-donut"></i><span>Documentation</span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="parent"><a href=""><i class="icon mdi mdi-chart-donut"></i><span>JOB
                                    Portal</span></a>
                            <ul class="sub-menu">
            ...
            <div class="col-sm-12">
                <div class="card card-table">
					...
					?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="center">
                                            <button type="button"
                                                class="btn btn-flat btn-info dropdown-toggle dropdown-icon"
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item"
                                                    href="?page=responses/manage&q=<?php echo $row['question'] ?>"><span
                                                        class="fa fa-edit text-primary"></span> Create Response</a>
                ...
                $(document).ready(function() {
                    $('.delete_data').click(function() {
                        _conf("Are you sure to delete this data?", "delete_question", [$(this).attr(
                            'data-id')])
                    })
                    $('.table').dataTable();
                })
